      ...
      <div id="textContainerHeader">
         ...
         <div id="curriculumBody">
            ...
            <p>
               ...
               <vue-mathjax :formula='`$h_{t - 1}$`'></vue-mathjax> to produce the next hidden state <vue-mathjax :formula='`$h_t$`'></vue-mathjax>. <u>Two:</u> both the input and output sequence, shown as red and
            ...
            <span style="font-size:14px; padding-top: -10px;"><i>one to one</i>: Image classification, <i>one to many</i>: Image captioning, <i>many to one</i>: Video classification, <i>many to many</i>:
            ...
            <p>
               Another characteristic to RNN's is that weights are shared temporally. In a Vanilla RNN, there are three tensors: <vue-mathjax :formula='`$W_{hh}$`'></vue-mathjax>, <vue-mathjax :formula='`$W_{xh}$`'></vue-mathjax>,
               and <vue-mathjax :formula='`$W_{hy}$`'></vue-mathjax> and bias parameters <vue-mathjax :formula='`$b_h$`'></vue-mathjax> and <vue-mathjax :formula='`$b_y$`'></vue-mathjax>.
               It helps me to think of the index of tensors as <vue-mathjax :formula='`$W_{(from)\\;(to)}$`'></vue-mathjax>
               to visualize where that particular tensor belongs. The two transformations shown below are core to a Vanilla RNN. Note that there are many bells and whistles you can add, generally to increase efficacy,
               which will also change the parameter and transformation count. An example being attention.
            </p>
            <p>
               <b>One:</b>
               <br>
