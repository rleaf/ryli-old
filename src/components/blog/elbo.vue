      ...
      <div id="textContainerHeader">
         ...
         <div id="curriculumBody">
            <div id="curriculumHeader">
               <div id="blogHeader">
                  <p style="padding: 0 !important; margin: 0 !important;">Tractability of the Variational Autoencoder</p>
            ...
            <div class="blogtoc">
               ...
               <ul>
                  ...
                  <li><a href="#">Lower Variational Bound (or ELBO)</a></li>
            ...
            <p>
               Optimizing Variational Autoencoders are problematic. Because of numerous distributions' intractibilities,  <vue-mathjax :formula='`$z$`'></vue-mathjax>
            </p>
